...
// COMPLETED: Define an interface for the Coordinates object
...
// COMPLETED: Define a class for the Weather object
...
class WeatherService {
  ...
  // COMPLETED: Create destructureLocationData method
  ...
  // COMPLETED: Create fetchAndDestructureLocationData method
  ...
  // COMPLETED: Create fetchWeatherData method
  ...
  // COMPLETED: Create fetchForecastData method
  ...
  // COMPLETED: Build parseCurrentWeather method
  ...
  // COMPLETED: Build parseForecastData method
